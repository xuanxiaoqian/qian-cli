...
var import_devService = __toESM(require("./core/devService"));
...
import_commander.program.command("start").description("\u5F00\u542F\u4E00\u4E2Ats\u5F00\u53D1\u73AF\u5883 \u4F8B\u5982: qian-cli start").action(async () => {
  await (0, import_devService.default)();
});
