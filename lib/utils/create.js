...
=======
  console.log();
  let sass = (_b = (_a = require(import_path.default.join(process.cwd(), "package.json"))["devDependencies"]["sass"]) != null ? _a : require(import_path.default.join(process.cwd(), "package.json"))["dependencies"]["sass"]) != null ? _b : false;
...
<<<<<<< HEAD
  import_ejs.default.renderFile(import_path.default.join(templateUrl, "page.ejs"), {
    pageName: sonName
=======
  let sass = (_c = (_b = require(import_path.default.join(process.cwd(), "package.json"))["devDependencies"]["sass"]) != null ? _b : require(import_path.default.join(process.cwd(), "package.json"))["dependencies"]["sass"]) != null ? _c : false;
  let isScss = sass ? `lang="scss" ` : "";
  import_ejs.default.renderFile(import_path.default.join(templateUrl, "page.ejs"), {
    pageName: sonName,
    isScss
