...
function checkTemplate(projectPath, isCwd) {
  var _a, _b;
  if (isCwd) {
    console.log((0, import_kolorist.red)("\u4E0B\u8F7D\u8FDC\u7A0B\u6A21\u677F \u4E0D\u652F\u6301\u64CD\u4F5C\u7B26 . "));
    process.exit(1);
  }
  let qianJson = (_b = (_a = (0, import_common.qianCliJson)()) == null ? void 0 : _a.template) != null ? _b : false;
  if (!qianJson) {
    return false;
  }
  if (Object.keys(qianJson).length > 1) {
    console.log((0, import_kolorist.red)(`\u51FA\u73B0\u591A\u4E2A\u5730\u5740 ${Object.keys(qianJson)},\u8BF7\u53EA\u6307\u5B9A\u4E00\u4E2A\u5730\u5740`));
    process.exit(1);
  } else if (Object.keys(qianJson)[0] === "gitUrl") {
    console.log((0, import_kolorist.green)(`\u5C06\u4F7F\u7528\u8FDC\u7A0B\u6A21\u677F\u4E0B\u8F7D ${qianJson["gitUrl"]}`));
    const spinner = (0, import_ora.default)("\u6B63\u5728\u521D\u59CB\u5316\u9879\u76EE...").start();
    (0, import_child_process.exec)(
      `git clone ${qianJson["gitUrl"]} ${import_path.default.basename(projectPath)}`,
      (err, stdout, stderr) => {
        if (err) {
          console.log((0, import_kolorist.red)("\u672C\u5730\u597D\u50CF\u6CA1\u6709git\u73AF\u5883\u5594~ \u8BF7\u4E0B\u8F7Dgit\u540E\u518D\u4F7F\u7528"));
          process.exit(1);
        }
